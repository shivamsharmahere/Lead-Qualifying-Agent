...
@router.get(
    "",
    response_model=LeadPaginationResponse,
    summary="List all leads",
    description="Get a paginated list of captured leads with optional priority filtering",
)
async def list_leads(
    priority: Optional[str] = Query(
        None, description="Filter by priority: high, medium, low, pending"
    ),
